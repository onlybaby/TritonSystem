...
INSERT INTO class(
  ...
  VALUES (1, 'MAE108', 'Adele', 100, 'sp', 2017);
INSERT INTO class(
  class_id, course_id, instructor, enrollment_limit, quarter, year)
  VALUES (2, 'CSE221', 'Kelly Clarkson', 100, 'sp', 2017);
INSERT INTO class(
  class_id, course_id, instructor, enrollment_limit, quarter, year)
  VALUES (3, 'CSE255', 'Flo Rida', 100, 'sp', 2017);
INSERT INTO class(
  class_id, course_id, instructor, enrollment_limit, quarter, year)
  VALUES (4, 'PHIL12', 'Adam Levine', 100, 'sp', 2017);
INSERT INTO class(
  class_id, course_id, instructor, enrollment_limit, quarter, year)
  VALUES (5, 'CSE221', 'Kelly Clarkson', 100, 'sp', 2017);
INSERT INTO class(
  class_id, course_id, instructor, enrollment_limit, quarter, year)
  VALUES (6, 'CSE105', 'Taylor Swift', 100, 'sp', 2017);
INSERT INTO class(
  class_id, course_id, instructor, enrollment_limit, quarter, year)
  VALUES (7, 'PHIL165', 'Taylor Swift', 100, 'sp', 2017);
INSERT INTO class(
  class_id, course_id, instructor, enrollment_limit, quarter, year)
  VALUES (8, 'MAE108', 'Selena Gomez', 100, 'sp', 2017);
INSERT INTO class(
  class_id, course_id, instructor, enrollment_limit, quarter, year)
  VALUES (9, 'CSE221', 'Justin Bieber', 100, 'sp', 2017);
INSERT INTO class(
  class_id, course_id, instructor, enrollment_limit, quarter, year)
  VALUES (10, 'CSE8A', 'Adele', 100, 'sp', 2017);
