        ...
        <tr>
            ...
            <%
                    ...
                    if (action != null && action.equals("update")) {
                        ...
                        PreparedStatement pstmt = conn.prepareStatement(
                            "UPDATE enrolled_list SET course_id = ?, pid = ?, grade_option = ?, grade_received = ?, " +
                            "unit = ?, quarter = ? " +
                            "WHERE CLASS_ID = ?");
                        ...
                        pstmt.setString(4, request.getParameter("GRADE_RECEIVED"));
            ...
            <%
                    ...
                    if (action != null && action.equals("delete")) {
                        ...
                        PreparedStatement pstmt = conn.prepareStatement(
                            "DELETE FROM enrolled_list WHERE CLASS_ID = ?");
